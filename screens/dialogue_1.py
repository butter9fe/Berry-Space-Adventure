...
class Dialogue:
    ...
    def show_gif_lv2(self):
        window2 = Launch("assets\dialog\BSO_MG_Text (15).png", duration=2000, next_window=self.go_next_level)
        window2.show()
    ...
    def show_gif_3(self):
        window2 = Launch("assets\dialog\BSO_MG_Text (13).png", duration=2000, next_window=self.show_gif_4)
        window2.show()

    def show_gif_2(self):
        window2 = Launch("assets\dialog\BSO_MG_Text (12).png", duration=2000, next_window=self.show_gif_3)
        window2.show()

    def launch_sequence(self):
        self.root = Launch("assets\dialog\BSO_MG_Text (11).png", duration=2000, next_window=self.show_gif_2)
        self.root.show()   
    

class Launch:
    def __init__(self, image_path, duration=3000, next_window=None):
